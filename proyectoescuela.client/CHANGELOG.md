...
- Create Angular project with ng: `ng new ProyectoEscuela.Client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`ProyectoEscuela.Client.esproj`).
