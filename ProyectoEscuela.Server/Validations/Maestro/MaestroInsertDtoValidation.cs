...
namespace ProyectoEscuela.Server.Validations.Maestro
{
    public class MaestroInsertDtoValidation : AbstractValidator<MaestroInsertDto>
    {
        public MaestroInsertDtoValidation()
        {
            RuleFor(a => a.Nombre).
